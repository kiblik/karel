...
interface
uses UUtils;
var _lMsgKarel_NoPic: string='Nenaöiel som obr·zok Karla! Karel nebude zobrazen˝!';
    ...
    _lMsgErrorOpakujCislo : string = 'za slovom opakuj by malo nasledovaù ËÌslo';
    _lMsgErrorOpakujKrat : string ='ch˝ba slovo ''krat'' v ötrukt˙re prÌkazu opakuj';
    _lMsgErrorOpakujEnd : string ='chybn· ötrukt˙ra prÌkazu opakuj - nenaöiel som ukonËenie';
    _lMsgErrorKym : string ='chybn· ötrukt˙ra prÌkazu kym';
    _lMsgErrorKymJe : string = 'za slovom kym musÌ nasledovaù "je" alebo "nie je"';
    _lMsgErrorKymJezanie : string = 'za slovom nie musÌ nasledovaù "je"';
    _lMsgErrorKymRob : string ='oËak·val som slovo rob';
    _lMsgErrorKymEnd : string ='chybn· ötrukt˙ra prÌkazu kym - nenaöiel som ukonËenie';
    _lMsgErrorAk : string ='chybn· ötrukt˙ra prÌkazu ak';
    _lMsgErrorAkJe : string = 'za slovom ak musÌ nasledovaù "je" alebo "nie je"';
    _lMsgErrorAkJezanie : string = 'za slovom nie musÌ nasledovaù "je"';
    _lMsgErrorAkTak : string = 'oËak·val som slovo tak';
    _lMsgErrorPresun : string ='Za prÌkazom presun oËak·vam dve ËÌsla';
    _lMsgErrorPrikaz : string ='Chybn· ötrukt˙ra prÌkazu ';
    _lMsgErrorPolozF : string ='Za prÌkazom polozf som oËak·val farbu.';
    ...
    _lMsgNoSavedWarn : string = 'Aktu·lny projekt bude vymazan˝. M·m pokraËovaù?';
    _lMsgNoSavedTitle : string='Neuloûen˝ projekt';
    _lMsgOpenTitle : string = 'Otvorenie projektu.';
    _lMsgReadingError : string ='ProblÈm s otvorenÌm s˙boru';
    ...
    _lBNewCaption : string = 'Nov˝'#13'prÌkaz';
    _lBDeleteCaption : string ='Zmaû'#13'prÌkaz';
    _lBRenameCaption : string ='Premenuj'#13'prÌkaz';
    _lNovyPrikaz : string = 'Nov˝ prÌkaz';
    _lMsgZadajMeno : string = 'Zadaj meno novÈho prÌkazu';
    _lMsgErrorRezSlovo1 : string =' nemÙûeö pouûiù ako meno prÌkazu. ';
    _lMsgErrorRezSlovo2 : string =' je zakladn˝ prÌkaz alebo je jeho s˙Ëasùou.';
    _lMsgErrorJednoSlovo : string ='Meno prÌkazu musÌ byù jedno slovo (bez medzier)';
    _lZmazatPrikaz : string = 'M·m zmazaù prÌkaz';
    _lPremenovaniePrikazu : string = 'Premenovanie prÌkazu ';
    _lZadajMeno : string ='Zadaj novÈ meno prÌkazu:';
    _MsgErrorRovnakeMeno : string = 'PÙvodnÈ a novÈ meno su rovnakÈ.';
    _MsgErrorUzExistuje : string = 'NemÙûem zmeniù meno na meno uû existuj˙ceho prÌkazu';
    _lRozmeryCaption : string = 'Nastavenie rozmerov miestnosti';
    _lRozmeryLBCaption : string = 'Rozmery miestnosti';
    _lRozmeryVyska : string ='V˝öka';
    _lRozmerySirka : string ='äÌrka';
    _lRozmeryDlzka : string ='DÂûka';
    _lButtonNastav : string = 'Nastaviù';
    _lButtonNenastav : string = 'Zruöiù';
    _lMoveCaption : string = 'Klikaj na öÌpky';
    _lBStopCaption : string = 'zastavenie'#13#10'programu';
    _lLimitsCaption : string ='Obmedzenia Karla';
    _lLimitsVykrocit : string ='PoËet teh·l, na ktorÈ vie Karel vykroËiù';
    _lLimitsSpomalit : string ='R˝chlosù Karla';
    _lZoomCaption : string ='Klikni na öÌpky na okrajoch posuvnÌka';
    _lMsgErrorPresun2 : string = 'Nespr·vne s˙radnice za prÌkazom presun';
    _lMsgStop : string ='program zastaven˝';
    _lMsgErrorKrok : string ='Karel nem· voæno, nemÙûe urobiù krok.';
    _lMsgErrorPolozPriStene : string = 'Karel stojÌ pred stenou, nem· kam poloûiù tehlu.';
    _lMsgErrorPolozVyska : string = 'Karel nemÙûe poloûiù tehlu vyööie ako je v˝öka miestnosti.';
    _lMsgErrorZoberNietco : string ='Pred Karlom nie je ûiadna tehla na zobratie.';
    _lOznacCmd : string ='oznac';
    _lOdznacCmd : string ='odznac';
    _lZnackaCmd : string ='znacka';
    _lPodmienkaCmd : string ='podmienka';
    _lErrorMsgPrikazZly : string ='Nespr·vny form·t prÌkazu';
    _lVysledokCnd : string = 'vysledok';
    _lMsgErrorCnd : string = 'ProblÈm so spracovanÌm podmienky';
    ...
    _lMsgRunError : string ='Chyba pri spustenÌ programu.';
    _lErrorMsgRuntime : string ='Chyba v programe';
    _lMsgUkladanie : string ='Ukladanie projektu';
    _lMsgNacitanie : string ='NaËÌtanie projektu';
    _lMsgNeulozeny : string ='Neuloûen˝ projekt';
...
begin
  ...
  if LowerCase(First(S))<>'podmienka' then
    begin
      ErrorMsg:='Chybna ötrukt˙ra podmienky';
      Exit
    end;
  First(S);
  if Last(S)<>'*podmienka' then
    begin
      ErrorMsg:='Chybn· ötrukt˙ra podmienky';
      Exit
    end;
  OK:=True;
  Result.Cmds:=S
